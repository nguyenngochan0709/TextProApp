...
public class BasicDocument extends Document 
{
	...
	public int getNumWords()
	{
		...
		List<String> words_list = getTokens("[A-za-z]+");
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		List<String> sentences_list = getTokens("[^.!?]+");
        return sentences_list.size();
	}
	...
	public int getNumSyllables()
	{
		...
		int syllables_totcount = 0;
		List<String> words_list = getTokens("[A-za-z]+");
		for (String word : words_list) {
			int syllables_wordcount = countSyllables(word);
			syllables_totcount += syllables_wordcount;
		}
		return syllables_totcount;
	}
